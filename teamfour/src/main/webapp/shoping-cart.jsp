			...
			<div class="col-lg-12 text-center">
				<div class="breadcrumb__text">
					...
					<div class="breadcrumb__option">
						<a href="./mainpage.jsp">Home</a> <span>Shopping Cart</span>
					</div>
				</div>
			</div>
		</div>
						...
						<tbody>
							...
							<tr>
								...
								<td class="shoping__cart__quantity">
									<div class="quantity">
										<div class="pro-qty">
											<input type="text" value="<%=list.get(i).getQty()%>"
												class="session_data">
										</div>
									</div>
								</td>
		...
		<div class="row">
			...
			<div class="col-lg-6">
				<div class="shoping__checkout">
					<h5>Cart Total</h5>
					<ul>
						<li>Subtotal <span><%=request.getAttribute("total")%></span></li>
						<li>Total <span><%=request.getAttribute("total")%></span></li>
					</ul>
